...
| Basic Econometric Concepts                                    | An overview that explains key principles and common methods.                 | [Link](https://github.com/Vikasnash/DEV/blob/master/Resource/Econometrics%20Book%20(Gujarati%2C%20D.%20N).pdf) |
| Linear Regression Analysis in Econometrics                    | Detailed treatment of OLS and linear regression techniques.                  | [Link](https://jrvargas.wordpress.com/wp-content/uploads/2011/01/wooldridge_j-_2002_econometric_analysis_of_cross_section_and_panel_data.pdf) |
| Generalized Method of Moments (GMM) in Econometrics             | Introduces GMM estimation methods with examples.                             | [Link 1](https://homepage.univie.ac.at/robert.kunst/gmm.pdf)  [Link 2](https://www.eco.uc3m.es/~ricmora/MEI/materials/Session_12_GMM.pdf) |
| Instrumental Variables and Two-Stage Least Squares              | Explores IV methods and their applications in overcoming biases.             | [Link](https://eml.berkeley.edu/~mcfadden/e240b_f01/ch4.pdf) [Link-2](https://scholar.harvard.edu/files/apassalacqua/files/section7_iv.pdf) |
| Panel Data Econometrics                                         | Advanced methods for handling data with both cross-sectional and time‐series dimensions. | [Link-1](https://www.example.com/panel-data-econometrics.pdf)  |
