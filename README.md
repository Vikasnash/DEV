...
| Basic Econometric Concepts ( Gujrati)                         | An overview that explains key principles and common methods.                 | [Link](https://github.com/Vikasnash/DEV/blob/master/Resource/Econometrics%20Book%20(Gujarati%2C%20D.%20N).pdf) |
...
| Instrumental Variables and Two-Stage Least Squares              | Explores IV methods and their applications in overcoming biases.             | [Link-1](https://eml.berkeley.edu/~mcfadden/e240b_f01/ch4.pdf) [Link-2](https://scholar.harvard.edu/files/apassalacqua/files/section7_iv.pdf) |
